...
import com.ivigilate.android.classes.SightingAdapter;
...
public class MainActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private LinkedHashMap<String, Sighting> mSightings;
    ...
    private void bindControls() {
                ...
                if (isScanning) {
                    ...
                    mIVigilateManager.setSightingListener(new ISightingListener() {
                        ...
                        public void onDeviceSighted(String mac, String uid, int rssi) {
                            final Sighting s = new Sighting(mac, uid, rssi);
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
        ...
        mLvSightings.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                final Sighting sighting = (Sighting) parent.getItemAtPosition(position);
